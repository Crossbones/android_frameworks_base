...
public class QuickSettingsController extends QuickSettings implements OnClickListener, CompoundButton.OnCheckedChangeListener {
    public QuickSettingsController(View anchor) {
        super(anchor);
    }
